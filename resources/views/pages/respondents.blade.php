...
@section('content')
    <div class="sm:flex sm:items-center sm:justify-center">
            ...
            <form action="{{ route('client.search') }}" method="post" autocomplete="off">
                ...
                <div class="relative mt-2 flex items-center gap-x-4">
                    <input type="text" name="search" id="search" required
                        class="block sm:w-96 w-full rounded-md border-0 px-3 py-1.5 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-violet-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6"
        ...
        <div class="flex items-center justify-between sm:gap-x-8">
            <div class="flex items-center justify-center mt-4 md:mt-8 lg:mt-8 gap-x-2">
    ...
    <div class="relative z-10 hidden" id="complete-client-modal" aria-labelledby="modal-title" role="dialog"
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-screen items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    class="relative overflow-y-scroll h-96 transform overflow-hidden rounded-lg bg-white px-6 pb-4 pt-5 text-left shadow-xl transition-all lg:w-1/2 w-full">
